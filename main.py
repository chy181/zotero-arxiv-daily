...
if __name__ == '__main__':
    ...
    send_email(args.sender, json.dumps(['hycheng@stu.ecnu.edu.cn','xjwu@stu.ecnu.edu.cn','xfqiu@stu.ecnu.edu.cn','1463250073@qq.com']), args.sender_password, args.smtp_server, args.smtp_port, html)
